...
__Ultron {ultroid_version}, powered by ultronBot__
"""
    ...
    if event.is_group:
        ...
        if str(event.sender_id) not in owner_and_sudos():
            ...
            if not udB.get("STARTMSG"):
                ...
                await event.reply(
                    f"Hey there [{get_display_name(u)}](tg://user?id={u.id}), this is Ultron Assistant of [{ultroid_bot.me.first_name}](tg://user?id={ultroid_bot.uid})!\n\n{ok}",
